                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800">Rp{{ number_format($totalPemasukanBulanan, 0, ',', '.') }}</div>
                        </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-1">
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Pemasukan Tahunan</div>
                            <div class="h6 mb-0 font-weight-bold text-gray-800">Rp{{ number_format($totalPemasukanTahunan, 0, ',', '.') }}</div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800">{{ $progressPersen }}%</div>
                        </div>
                        <i class="fas fa-clipboard-list fa-lg text-gray-300"></i>
                    </div>
                    <div class="progress progress-sm mt-2">
                        <div class="progress-bar bg-info" role="progressbar" style="width: {{ $progressPersen }}%" aria-valuenow="{{ $progressPersen }}" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center justify-content-between">
                        <div>
                            ...
                            <div class="h6 mb-0 font-weight-bold text-gray-800">{{ $pendingRequests }}</div>
                        </div>
